...
/**
 * Cette classe sauvegarde le code de vérification du numéro de téléphone d'un utilisateur sur le système TaxiRide.
 * @author KITIO
 *
 */
...
@AllArgsConstructor
@NoArgsConstructor
@Entity(name = "PHONE_VERIFICATION_TOKEN")
public class PhoneVerificationToken extends DateAudit {
